export class Blog {
    salaryCheck({ highestEducation = 'In Ausbildung', experience = '2-5 Jahre', willingnessToTravel = 'Ein paar Tage im Monat', state = 'Berlin' }) {
        ...
        cy.get('input[autocomplete="given-name"]').should('be.visible');
    }
}